...
function doGet(e) {
  ...
  if (__p.api === 'tidy' && __p.key === 'mlrtidy0623') { return ContentService.createTextOutput(normalizeAssets()).setMimeType(ContentService.MimeType.TEXT); } // TEMP maintenance endpoint — removed right after the run
